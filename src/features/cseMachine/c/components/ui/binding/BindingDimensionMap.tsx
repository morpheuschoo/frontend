...
export class BindingDimensionMap {
  ...
  register(address: number, x: number, y: number, width: number, height: number, additionalBendDistance: number) {
    this.dimensions.set(address, new BindingDimensions(x, y, width, height, additionalBendDistance));
  }
